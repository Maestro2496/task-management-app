...
export default function TaskDescription({open, setOpen, task, taskCompleted}) {
  return (
                  ...
                  <div className="space-y-2 flex flex-col items-center justify-center">
                    {task.subtasks.map((subtask) => (
                      ...
                      >
                        ...
                        <p className={clsx(subtask.isCompleted ? "line-through decoration-gray-600 decoration-1 text-gray-500" : "")}>
                          {subtask.title}
                        </p>
                      </div>
                    ))}
